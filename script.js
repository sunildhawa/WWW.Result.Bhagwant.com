          ...
          if (student) {
              ...
              <div  style='border: 1px solid gray; position: relative; margin-top: 20px; width: 327px'>
                ...
                <div id='hi' style='border:1px solid gray; border-right: none;  margin-top: 62px; border-left: none; border-bottom: none;'>
                    <p><strong style='color: #004080; font-size: 12px;'> Name:</strong>  ${student.name}</p>
                    <p><strong style='color: #004080; font-size: 12px;'> Father's Name:</strong>  ${student.Fname}</p>
                    <p><strong style='color: #004080; font-size: 12px;'> Mother's Name:</strong>  ${student.Mname}</p>
                    <p><strong style='color: #004080; font-size: 12px;'> Roll No:</strong>  ${student.roll}</p>
                    <p><strong style='color: #004080; font-size: 12px;'> Enrollment No:&nbsp;</strong>  ${student.EnrollmentNo}</p>
                    <p><strong style='color: #004080; font-size: 12px;'> Institute:</strong>  ${student.Institute}</p>
                </div>
              </div>
